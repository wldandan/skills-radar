...
> **成熟度**: 🟡 成长期 · **综合评分**: **0.55**
>
> **业界判断**：8+ 个产品占据**最拥挤**的赛道（失败驱动 / 文档转化 / 会话提取 / 轨迹蒸馏 / 领域工单 / GEPA 进化），每条路径都局限于特定输入类型，差异化空间正在缩小。
...
| [Skill Seekers](tech-skill-seekers) | 社区开源 | 18 源 → 20 平台 | AI 增强 3/10 → 9/10 |
| [EvoSkill](tech-evoskill) | Sentient AGI | 三 Agent 失败驱动 | 零样本迁移 +5.3% |
| [EvoSkills / CoEvoSkills](tech-evoskills) | 学术 | Surrogate + Oracle 协同进化 | **75% vs 人工 34.1%** |
| [Claudeception](tech-claudeception) | 社区 (506+ ★) | Claude Code 会话提取 | 4 条件提取标准 |
| [Trace2Skill](tech-trace2skill) | 阿里 Qwen + ETH | 并行轨迹蒸馏 | 35B +57.65pp 超 122B |
| [SkillForge](tech-skillforge) | 阿里云 | 历史工单挖掘 | 阿里云 5 个真实场景 |
